...
SECRET_KEY = 'django-insecure-tid6djd6%0v1^l#-yg1@-m!n-k$g)$2t%p5vsz-@z%o1paxh*&'
...
INSTALLED_APPS = [
    'registration', # se pone al principio para asegurarse de que si hay conflictos, use esta siempre
